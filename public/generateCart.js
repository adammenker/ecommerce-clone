    ...
    for(let i = 0; i < productArr.length; i++) {
        ...
        tableBody += 
            '<tr>' +
                ...
                `<td>${"$" + productPrice}</td>` +
                `<td>
                    <form id="remove-item-from-cart-form" action="/" method="POST" autocomplete="off">
                        <button class="btn btn-outline-secondary" id="remove-item-from-cart-button" type="submit">
