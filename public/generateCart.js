            ...
            '<tr>' +
                ...
                `<td>
                    <form action="/cart" method="post" autocomplete="off">
                        <button class="btn btn-outline-secondary" type="submit" name="remove-item-product-id" value="${productID}"  onclick="removeItemRow(${productID})">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle remove-item-from-cart-icon" viewBox="0 0 16 16">
